...
return [
    'service_manager' => [
        'factories' => [
            \IbmiOne\V1\Rest\FirstRestService\FirstRestServiceResource::class => \IbmiOne\V1\Rest\FirstRestService\FirstRestServiceResourceFactory::class,
        ],
    ],
    'router' => [
        'routes' => [
    ...
    'zf-versioning' => [
        'uri' => [
            0 => 'ibmi-one.rest.first-rest-service',
        ],
    ],
    'zf-rest' => [
